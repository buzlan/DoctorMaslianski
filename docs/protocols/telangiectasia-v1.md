...
- Once this version is `approved`, later clinical content changes create a new monotonic version (for example `telangiectasia-v2.md`), not a mutation of version 1.
