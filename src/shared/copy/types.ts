export type AppCopy = {
  ...
  diary: {
    ...
    painLabel: string;
    painQuestion: string;
    painGuideTitle: string;
    painGuideOpen: string;
    painGuideClose: string;
    painGuideNone: string;
    painGuideMild: string;
    painGuideModerate: string;
    painGuideSevere: string;
    painGuideExtreme: string;
    painNone: string;
    painModerate: string;
    painStrong: string;
    swellingLabel: string;
    swellingQuestion: string;
    swellingNone: string;
    swellingModerate: string;
    swellingStrong: string;
